...
### Can I run DClaw HR without Kubernetes?

Yes, for local development:

```bash
cd dclaw-hr/frontend && npm run dev
cd dclaw-hr/backend && uvicorn dclaw_hr.main:app --reload
```
