...
- [ ] `backend/app/api/main.py` CORS `allow_origins` includes `http://localhost:3008`
...
- [ ] `/employees/new` page — **missing**
- [ ] Time-off approve/reject UI — **missing**
- [ ] Employee edit page — **missing**
- [ ] `net_pay` auto-calculation — **missing** (manually entered)
- [ ] HR recruitment module — **stub with random data, not registered in main.py**
- [ ] CORS port 3008 — **missing** (currently 3017/3000)
